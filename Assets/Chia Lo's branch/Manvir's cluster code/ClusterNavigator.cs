...
public class ClusterNavigator : MonoBehaviour
{
    ...
    [SerializeField] private List<Transform> waypoints; // A list of all possible waypoints to target
    ...
    [SerializeField] private Animator animator; // The animator component for the agent
    ...
    bool IsAtTarget()
    {
        if (Vector3.Distance(transform.position, target.position) <
            acceptableDistance) // Return true if the agent is within an acceptable distance of the target
        {
